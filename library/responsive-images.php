...
add_image_size( 'featured-small', 640, 200, false ); // name, width, height, crop
add_image_size( 'featured-medium', 1280, 560, false );
add_image_size( 'featured-large', 1440, 560, false );
add_image_size( 'featured-xlarge', 1920, 560, false );
