...
function foundationpress_pagination() {
	...
	$paginate_links = paginate_links( array(
		...
		'mid_size' => 5,
		'prev_next' => true,
		'prev_text' => __( '&laquo;', 'vibrant-life-theme' ),
		'next_text' => __( '&raquo;', 'vibrant-life-theme' ),
		'type' => 'list',
	) );
...
function foundationpress_menu_fallback() {
	...
	printf( __( 'Please assign a menu to the primary menu location under %1$s or %2$s the design.', 'vibrant-life-theme' ),
		/* translators: %s: menu url */
		sprintf(  __( '<a href="%s">Menus</a>', 'vibrant-life-theme' ),
			get_admin_url( get_current_blog_id(), 'nav-menus.php' )
		),
		/* translators: %s: customize url */
		sprintf(  __( '<a href="%s">Customize</a>', 'vibrant-life-theme' ),
